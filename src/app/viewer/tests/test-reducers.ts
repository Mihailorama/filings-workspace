...
describe('viewerTablesReducer', () => {
  const initial: ViewerState = reducer(undefined, {type: '????'});
  ...
  it('clears tables when fetching', () => {
    const after: ViewerState = reducer(exampleViewerState, fetchTablesAction('1234'));
  ...
  it('stores name and tables when received', () => {
    ...
    const after: ViewerState = reducer(exampleViewerState, receivedTablesAction('1234', filingName, tables));
    expect(after).toBeDefined();
  ...
  it('stores error when failed', () => {
    const after: ViewerState = reducer(exampleViewerState, failedTablesAction('1234', 'Oh no'));
    expect(after).toBeDefined();
...
describe('viewerPageReducer', () => {
  ...
  it('clears page when fetching', () => {
    const after: ViewerState = reducer(exampleViewerState, fetchPageAction('1234', page));
    expect(after).toBeDefined();
  ...
  it('stores page when received', () => {
    ...
    const after: ViewerState = reducer(exampleViewerState, receivedPageAction('1234', page, zOptions, rendering));
    expect(after).toBeDefined();
  ...
  it('stores error when failed', () => {
    const after: ViewerState = reducer(exampleViewerState, failedPageAction('1234', page, 'Oh no'));
    expect(after).toBeDefined();
